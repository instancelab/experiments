...
function displayInventory() {
	...
	Inventory.forEach(itemCode => {
		...
		itemElement.innerHTML = `
			<div class="collectible-icon-container">
				<img class="collectible-icon" src="assets/${item.item_icon}" alt="${item.display_name}" />
			</div>
